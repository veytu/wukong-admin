export default {
  ...
  'menu.ConfigurationManagement.GeneralSettings': 'GeneralSettings',
  'menu.TicketManagement': 'TicketManagement',
  'menu.TicketManagement.ExceptionIssueTicket': 'ExceptionIssueTicket',
};
